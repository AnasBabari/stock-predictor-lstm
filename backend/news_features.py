...
FINANCIAL_LEXICON = {
    ...
    "guidance boosted": 2.5,
    "missed estimates": -2.0,
    "beat estimates": 2.0,
    "beat expectations": 2.0,
    "missed expectations": -2.0,
    "top-line beat": 1.5,
    "bottom-line beat": 1.5,
    "profit warning": -2.5,
    "revenue decline": -1.5,
    "revenue surge": 2.0,
    "record revenue": 2.5,
    ...
    "free cash flow beat": 1.5,
    "demand slump": -2.0,
    "demand surge": 2.0,
    "subscription growth": 1.5,
    ...
    "dividend boost": 1.5,
    "dividend cut": -2.0,
    "dividend suspension": -2.5,
    "special dividend": 1.5,
    "share buyback": 1.5,
    "repurchase program": 1.5,
    "stock split": 1.0,
    "merger": 1.2,
    "acquisition": 1.2,
    "buyout": 1.5,
    ...
    "layoffs": -1.5,
    "workforce reduction": -1.2,
    "restructuring": -0.8,
    "plant closure": -1.5,
    "ceo resignation": -1.2,
    "cfo resignation": -1.5,
    "accounting error": -2.5,
    "restatement": -2.5,
    "bankruptcy": -3.5,
    "chapter 11": -3.5,
    "insolvency": -3.5,
    ...
    "credit rating downgrade": -2.0,
    "credit rating upgrade": 1.5,
    ...
    "fda fast track": 2.0,
    "fda rejection": -3.0,
    "complete response letter": -2.5,
    "clinical trial success": 2.5,
    "clinical trial fail": -3.0,
    "patent grant": 1.5,
    "patent invalidation": -2.0,
    # ── Geopolitical, Energy & Macroeconomic Shocks ───────────────────
    "war": -2.5,
    "military strike": -2.0,
    "airstrike": -2.0,
    "missile attack": -2.5,
    "invasion": -3.0,
    "conflict escalation": -2.0,
    "ceasefire": 1.5,
    "peace treaty": 2.0,
    "sanctions": -2.0,
    "trade tariffs": -1.5,
    ...
    "export ban": -2.0,
    "import embargo": -2.0,
    "strait of hormuz": -2.0,
    "oil supply disruption": -2.0,
    "crude oil spike": -1.5,
    "energy crisis": -2.0,
    "opec supply cut": -1.2,
    "opec output hike": 1.0,
...
EVENT_KEYWORDS = {
    ...
    "guidance": ("guidance", "outlook", "forecast raise", "profit warning", "full-year outlook"),
    "analyst_rating": ("upgrade", "downgrade", "price target", "outperform", "underperform"),
    "dividend_buyback": ("dividend", "share buyback", "repurchase program", "special dividend"),
    "merger_acquisition": ("merger", "acquisition", "buyout", "takeover", "spin-off"),
    "legal_regulatory": (
        "lawsuit",
        "investigation",
        "regulatory",
    ...
    "biotech_clinical": ("fda", "clinical trial", "phase 3", "drug approval", "efficacy"),
    "management_governance": ("ceo", "cfo", "resigns", "stepping down", "appointed"),
    "financing_debt": ("offering", "debt issuance", "refinancing", "credit facility", "liquidity"),
    "restructuring_workforce": ("layoffs", "restructuring", "cost cutting", "severance"),
    "geopolitical_macro": (
        "war",
        "sanctions",
        "tariffs",
