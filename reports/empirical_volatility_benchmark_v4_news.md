...
> **INVALIDATED:** This historical report was generated by the former synthetic-news fallback, not by the claimed point-in-time headline archive. It must not be used as evidence for or against real financial-news features. The pipeline now requires genuine timestamped news and fails closed when it is absent.
